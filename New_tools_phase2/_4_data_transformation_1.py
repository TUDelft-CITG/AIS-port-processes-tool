...
# Dry bulk
    ...
    # Cleaned/ preprocessed dataset with column: in small_terminal
    data_AIS4 = pd.read_csv('Processed_data_db_lisbon_TERMINAL.csv')
    data_AIS_04 = data_AIS4.copy()
    seaweb4 = pd.read_csv('Seaweb-dataset-LisbonDB.csv')
    ...
    data_AIS05 = pd.read_csv('Processed_data_db_NH_TERMINAL.csv')
    seaweb05 = pd.read_csv('Seaweb-dataset-NH-DB.csv')
    # Apply processing steps
    data_processed5 = processing_for_ML(data_AIS05, seaweb05)
    # Export processed dataframes
    data_processed5.to_csv('Features_db_NH.csv')

    data_AIS_16 = pd.read_csv('Processed_data_db_rdam_TERMINAL.csv')
    data_seaweb_Rdam_EMO1 = pd.read_csv('Seaweb-dataset-Rotterdam_EMO_DB1.csv')
    data_seaweb_Rdam_EMO2 = pd.read_csv('Seaweb-dataset-Rotterdam_EMO_DB2.csv')
    data_seaweb_Rdam_EMO3 = pd.read_csv('Seaweb-dataset-Rotterdam_EMO_DB3.csv')
    data_seaweb_Rdam_EMO4 = pd.read_csv('Seaweb-dataset-Rotterdam_EMO_DB4.csv')
    data_seaweb_Rdam_EMO5 = pd.read_csv('Seaweb-dataset-Rotterdam_EMO_DB5.csv')
    data_seaweb_Rdam_EMO6 = pd.read_csv('Seaweb-dataset-Rotterdam_EMO_DB6.csv')
    ...
    data_AIS27 = pd.read_csv('Processed_data_db_vliss_TERMINAL.csv')
    seaweb27 = pd.read_csv('Seaweb-dataset-VlissingenDB.csv')
    # Apply processing steps
...
# Liquid bulk
    ...
    # Cleaned/ preprocessed dataset with column: in small_terminal
    data_AIS41 = pd.read_csv('Processed_data_lb_belfast_TERMINAL.csv')
    data_AIS_041 = data_AIS41.copy()
    seaweb41 = pd.read_csv('Seaweb-dataset-belfast.csv')
    ...
    data_AIS051 = pd.read_csv('Processed_data_lb_lisbon_TERMINAL.csv')
    seaweb051 = pd.read_csv('Seaweb-dataset-Lisbon-LBT.csv')
    # Apply processing steps
    data_processed51 = processing_for_ML(data_AIS051, seaweb051)
    # Export processed dataframes
    data_processed51.to_csv('Features_lb_lisbon.csv')

    data_AIS_161 = pd.read_csv('Processed_data_lb_rdam_TERMINAL.csv')
    data_seaweb_Rdam_lb1 = pd.read_csv('Seaweb-dataset-Rdam-LBT_b2.csv')
    data_seaweb_Rdam_lb2 = pd.read_csv('Seaweb-dataset-Rdam-LBT_b1.csv')
    ...
    data_AIS271 = pd.read_csv('Processed_data_lb_vliss_TERMINAL.csv')
    seaweb271 = pd.read_csv('Seaweb-dataset-Vliss-LBT.csv')
    # Apply processing steps
